...
export const demoTasks: TaskData[] = [
  ...
  { id: "o3", taskCode: "O3", title: "Finalize US United Logistics / Star Navigation / UUL incentive alignment", status: "in_progress", priority: "high", assignee: { name: "Alic Ge", initials: "AG", office: "CN" }, dueDate: "Apr 15", workstream: "Operations", workstreamColor: "#f97316", phase: 1, isCrossOffice: true },
